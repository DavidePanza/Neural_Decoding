...
def main():
    ...
    PATH = '/scratch/panzad87/work/eeg_synthetic/eeg_data/epoched/'
    OUT_PATH = '/scratch/panzad87/work/eeg_synthetic/decoding_results/'
    SUBJ = int(sys.argv[1])
